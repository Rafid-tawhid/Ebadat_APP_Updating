...
public class DuaListFragment extends Fragment {
    ...
    private void initData() {
        ...
        duaItems.add(new DuaItems("মসজিদ হতে বের হওয়ার দোয়া", "اَللّٰهمَّ اِنِّي اَسْٮَٔلُكَ مِنْ فَضْلِكِ","আল্লাহুম্মা ইন্নী আসআলূকা মিস ফাযলিকা","আমার বাংলা নিয়ে প্রথম কাজ করবার সুযোগ তৈরি হয়েছিল অভ্র^ নামক এক যুগান্তকারী বাংলা সফ্টওয়্যার হাতে পাবার মধ্য দিয়ে।","1"));
